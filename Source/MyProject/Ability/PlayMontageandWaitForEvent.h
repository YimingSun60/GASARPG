 ...
 */
UCLASS()
class MYPROJECT_API UPlayMontageandWaitForEvent: public UAbilityTask
{
	GENERATED_BODY()
...
public:
	 ...
	 * OnInterrupted is called if another montage overwritesC this, and OnCancelled is called if the ability or task is cancelled
	 *
