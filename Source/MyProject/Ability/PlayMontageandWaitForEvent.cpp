...
#include "MyProject\Ability\PlayMontageandWaitForEvent.h"
...
void UPlayMontageandWaitForEvent::Activate()
{
	...
	if (RPGAbilitySystemComponent)
	{
		...
		if (AnimInstance != nullptr)
		{
			...
			EventHandle = RPGAbilitySystemComponent->AddGameplayEventTagContainerDelegate(EventTags, FGameplayEventTagMulticastDelegate::FDelegate::CreateUObject(this, &UPlayMontageandWaitForEvent::OnGameplayEvent));
...
UAbilitySystemComponent* UPlayMontageandWaitForEvent::GetTargetASC()
{
