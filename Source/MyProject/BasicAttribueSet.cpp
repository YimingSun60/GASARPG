...
void UBasicAttribueSet::OnRep_MaxHealth(const FGameplayAttributeData& OldMaxHealth)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UBasicAttribueSet, MaxHealth, OldMaxHealth);
}

void UBasicAttribueSet::OnRep_HealthRegenRate(const FGameplayAttributeData& OldHealthRegenRate)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UBasicAttribueSet, HealthRegenRate, OldHealthRegenRate);
}

void UBasicAttribueSet::OnRep_Stamina(const FGameplayAttributeData& OldStamina)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UBasicAttribueSet, Stamina, OldStamina);
}

void UBasicAttribueSet::OnRep_MaxStamina(const FGameplayAttributeData& OldMaxStamina)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UBasicAttribueSet, MaxStamina, OldMaxStamina);
}

void UBasicAttribueSet::OnRep_StaminaRegenRate(const FGameplayAttributeData& OldStaminaRegenRate)
{
